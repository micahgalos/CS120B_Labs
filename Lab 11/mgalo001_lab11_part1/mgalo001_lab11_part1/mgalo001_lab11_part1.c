/*
 * mgalo001_lab11_part1.c
 *
 * Created: 5/8/2019 1:09:11 AM
 * Author : Micah Galos - mgalo001@ucr.edu
 * Partner(s) Name & E-mail: Ronny Anariva - ranar001@ucr.edu
 * Lab Section: 027
 * Assignment: Lab 11 Exercise 1
 * Exercise Description: Modify the keypad code to be in an SM task. Then, modify the keypad SM to utilize the simple task scheduler 
 *						 format (refer to PES Chp 7). All code from here on out should use the task scheduler. 
 *
